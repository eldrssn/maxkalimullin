...
const Home = () => (
  <>
    ...
    <article className='mb-7'>
      ...
      <span className='font-bold'>Front-End Developer</span> with more than
      2-year track record in developing web applications. I am proficient in
      React, Next.js, and Redux, with expertise in all stages of interface
      component design. I am dedicated to delivering high-quality,
      web-responsive applications while constantly learning and growing in the
      field.
    </article>
